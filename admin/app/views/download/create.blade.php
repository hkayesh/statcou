@extends('master')
@section('content')
<div id="page-heading" style="display: none"><h1>Downloads</h1></div>
<h1 style="margin: 0 0 15px 20px">Create Download</h1>
        ...
        <td>
            ...
            <div id="content-table-inner">
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="5" >
                            <div class="green-left" style=" height: 45px; line-height: 28px">Download saved successfully</div>
                        </td>
                    </tr>
                    @endif
                    <tr valign="top">
                        <td>
                            <!-- start id-form -->
                            {{ Form::open(array ('route' => 'download.store', 'files' => true)) }}
