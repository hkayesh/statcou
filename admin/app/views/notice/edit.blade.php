@extends('master')
@section('content')
<div id="page-heading" style="display: none"><h1>Notice</h1></div>
<h1 style="margin: 0 0 15px 20px">Edit Notice</h1>
            ...
            <div id="content-table-inner">
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr valign="top">
                        <td>
                            <!-- start id-form -->
                            {{ Form::open(array ('url' => URL::to('notice/'.$notice->id), 'files' => true, 'method' => 'PUT')) }}
                            <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                <tr>
                                    <th valign="top">Description:</th>
                                    <td><textarea rows="" cols="" class="form-textarea" name="description" >{{ $notice ->description }}</textarea></td>
                                    <td style="width: 40%">
