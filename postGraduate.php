...
<script type="text/javascript">
      $(document).ready(function() {
            document.title = 'Prost Graduate | Statistics Dept. of COU';
            $( ".selected" ).attr( "class", "" );
...
<div id="content_section">
    ...
    <div class="col1">  
        ...
        <div class="content_heading">
            <div class="heading"><h2>Post Graduate Course Schedule</h2> </div>
            <!--<div class="share"><a  href="course.html#">Share with friends</a></div>-->
        </div>
        <p>
            The syllabus and course schedule for Post graduate is under development.
        </p>
